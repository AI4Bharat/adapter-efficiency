...
parser.add_argument("--shard_num", type=int, default= 5)
...
parser.add_argument("--model_name", type=str, default="20_percent_")  # ner was commented
...
trainer = MultitaskTrainer(
    ...
    args=transformers.TrainingArguments(
        f"callbacks_MTL_{args.model_name}_{args.add_task}_{args.shard_num}_{args.batch_size}_{args.learning_rate}_{args.model_path}_{args.checkpont_p}",
