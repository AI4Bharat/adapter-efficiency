...
#callbacks_MTL_apart_xnli_2_xnli_32_3e-05_7_checkpoint-33045
#callbacks_MTL_apart_sentiment_2_sentiment_32_3e-05_7_checkpoint-54861
#callbacks_MTL_apart_copa_2_qa_32_3e-05_7_checkpoint-80864
#callbacks_MTL_apart_copa_2_paraphrase_32_3e-05_7_checkpoint-86972
#callbacks_MTL_apart_ner_2_ner_32_3e-05_7_checkpoint-91728
#callbacks_MTL_apart_copa_2_copa_32_3e-05_7_checkpoint-66726
...
parser.add_argument("--shard_num", type=int, default= 20)
...
dataset_sentiment = dataset_sentiment.shuffle(seed=args.seed)
...
if args.add_task == "xnli":
    ...
    dataset_xnli['train'] = dataset_xnli['train'].shard(num_shards=35, index=0)
    dataset_paraphrase['train'] = dataset_paraphrase['train'].shard(num_shards=args.shard_num, index=0)
    dataset_sentiment['train'] = dataset_sentiment['train'].shard(num_shards=args.shard_num, index=0) #15
    dataset_qa['train'] = dataset_qa['train'].shard(num_shards=args.shard_num, index=0)
    dataset_copa['train'] = dataset_copa['train'].shard(num_shards=args.shard_num, index=0)
    dataset_dict = {
        "xnli": dataset_xnli, 
    ...
    dataset_xnli['train'] = dataset_xnli['train'].shard(num_shards=args.shard_num, index=0) #12
    dataset_ner['train'] = dataset_ner['train'].shard(num_shards=args.shard_num, index=0)
    dataset_paraphrase['train'] = dataset_paraphrase['train'].shard(num_shards=args.shard_num, index=0)
    dataset_sentiment['train'] = dataset_sentiment['train'].shard(num_shards=args.shard_num, index=0)
    dataset_qa['train'] = dataset_qa['train'].shard(num_shards=args.shard_num, index=0)
...
trainer = MultitaskTrainer(
    ...
    args=transformers.TrainingArguments(
        f"callbacks_MTL_{args.model_name}_{args.add_task}_{args.shard_num}_{args.model_path}_{args.checkpont_p}",
